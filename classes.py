...
class HeadHunter(Engine):
    url = "https://api.hh.ru/locale?host=hh.ru"
...
class Connector:
    def __init__(self, keyword, vacansies_json):
        self.filename = f"{keyword.title()}.json"

    def insert(self, vacansies_json):
        with open(self.filename, "w", encoding="utf-8") as file:
            json.dump(vacansies_json, file, indent=4)
